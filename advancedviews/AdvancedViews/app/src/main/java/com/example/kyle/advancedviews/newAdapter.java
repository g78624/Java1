...
public class newAdapter extends BaseAdapter {
    ...
    public newAdapter(Context _context, ArrayList<VideoGames> _videoGames){
    ...
    public View getView(int _position, View _convertView, ViewGroup _parent) {
        ...
        TextView listTitle = (TextView) _convertView.findViewById(R.id.gameTitleView);
        listTitle.setText(videoGames.getTitle());

        TextView listPlatform = (TextView) _convertView.findViewById(R.id.platformText);
        listPlatform.setText(videoGames.getPlatform());
